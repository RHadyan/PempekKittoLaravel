...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
    <div class="container-fluid">
      <h1 class=" mb-0 text-black text-uppercase d-none d-lg-inline-block">Tekwan</h1>
    </div>
  </nav>
        <!-- End Navbar -->
        <!-- Header -->
                        ...
                        <form method="POST" action="{{route('admin.savepempek')}}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="kode_kategori" id="">
                                    ...
                                    <option class="option" selected value="Tekwan">Tekwan</option>
